...
(function () {
    ...
    const DICT = {
        en: {
            ...
            nav_sheet_add_journey: "Add Journey - Google Sheet Style",
            nav_sheet_add_journey_desc: "Fast, spreadsheet-style entry for multiple journeys",
            sheet_add_journey_title: "ADD JOURNEY",
        ...
        hi: {
            ...
            nav_sheet_add_journey: "यात्रा जोड़ें - गूगल शीट स्टाइल",
            nav_sheet_add_journey_desc: "कई यात्राओं के लिए तेज़, स्प्रेडशीट-स्टाइल एंट्री",
            sheet_add_journey_title: "यात्रा जोड़ें",
