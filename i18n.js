...
(function () {
    ...
    const DICT = {
        en: {
            ...
            sheet_add_journey_title: "ADD JOURNEY (SHEET STYLE)",
            sheet_add_journey_hint: "➡️ Scroll sideways to see all columns. Fill a row, tap Save — a fresh row opens automatically.",
