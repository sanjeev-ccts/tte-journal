...
(function () {
    ...
    const DICT = {
        en: {
            ...
            nav_sheet_add_journey: "Add Journey - Old Style",
            nav_sheet_add_journey_desc: "Fast & Clean old style entry",
            sheet_add_journey_title: "JOURNEY SHEET",
            sheet_add_journey_hint: "Scroll sideways to see all columns. Fill a row, tap Save",
            sheet_col_train: "Train No.",
            sheet_col_from: "From",
            sheet_col_to: "To",
            sheet_add_btn: "✚ Add Journey",
            sheet_edit_journey_btn: "✏️ Edit Journey",
            sheet_save_edited_btn: "✔ Save Edited",
            sheet_col_dep_date: "Dep Date",
            sheet_col_dep_time: "Dep Time",
            sheet_col_arr_date: "Arr Date",
            sheet_col_arr_time: "Arr Time",
            sheet_col_save: "Save/Edit",
            sheet_col_edit: "Edit",
            sheet_col_delete: "Del",
            sheet_add_rest_leave: "Add Rest & Leave",
            sheet_edit_delete_duty: "Edit/Delete Duty",
            sheet_quick_add_journey: "Quick Add Journey",
        ...
        hi: {
            ...
            nav_sheet_add_journey: "यात्रा जोड़ें - ओल्ड स्टाइल",
            nav_sheet_add_journey_desc: "तेज़ और साफ़ ओल्ड स्टाइल एंट्री",
            ...
            sheet_col_train: "ट्रेन नंबर",
            sheet_col_from: "से",
            sheet_col_to: "तक",
            sheet_add_btn: "✚ यात्रा जोड़ें",
            sheet_edit_journey_btn: "✏️ यात्रा एडिट करें",
            sheet_save_edited_btn: "✔ Edited Save करें",
            sheet_col_dep_date: "प्रस्थान तिथि",
            sheet_col_dep_time: "प्रस्थान समय",
            sheet_col_arr_date: "आगमन तिथि",
            sheet_col_arr_time: "आगमन समय",
            sheet_col_save: "Save/Edit",
            sheet_col_edit: "एडिट",
            sheet_col_delete: "हटाएं",
            sheet_add_rest_leave: "आराम/छुट्टी जोड़ें",
            sheet_edit_delete_duty: "ड्यूटी एडिट/डिलीट करें",
            sheet_quick_add_journey: "क्विक ऐड जर्नी",
