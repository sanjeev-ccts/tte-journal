...
(function () {
    ...
    const DICT = {
        ...
        hi: {
            ...
            offline_could_not_verify_session: "आप offline हैं। कृपया इंतज़ार करें... Dashboard कुछ ही seconds में load हो जाएगा।",
            already_editing_title: "पहले से Edit हो रहा है",
            already_editing_msg: "बदलाव save करने के लिए table के नीचे '✔ Save Edited' पर tap करें।",
            backup_row: "बैकअप",
            ...
            sleep_info_text: "यह दिखाता है कि train duty की वजह से आपकी ideal sleep कितनी बाधित होती है — dark circles पक्के हैं। लेकिन यह Railways को चलाने का ही एक हिस्सा है, और अपने तरीके से, देश के प्रति एक छोटा सा फ़र्ज़ भी। इसे गर्व से निभाएं, झिझक से नहीं।",
            ...
            nha_description: "{year} में National Holiday Allowance के लिए योग्य त्योहार, आपके Railway Board circular के अनुसार।",
