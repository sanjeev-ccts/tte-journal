...
(function () {
    ...
    const DICT = {
        ...
        hi: {
            ...
            ok: "ठीक है",
            are_you_sure: "क्या आप श्योर हैं?",
            yes: "हां",
            no: "नहीं",
            ...
            profile_note_fill_carefully: "यह data ध्यान से भरें। यह सीधे आपकी TA/NDA calculation और PDF generation में इस्तेमाल होगा।",
            profile_nearby_hq_desc: "यह एक nearby HQ station है जहां से कभी-कभी journey शुरू होती है, आपके Main HQ के अलावा — इस group के अंदर travel के लिए TA claim नहीं होता।",
            profile_diversion_stn_desc: "यह वह station है जहां से journey शुरू होती है, आपके Main या Nearby HQ के अलावा, जिसमें TA claim होता है — जैसे BSB HQ के लिए DDU।",
            profile_dest_stations_desc: "अपने सामान्य destination station और जाने-पहचाने diversion route सेट करें (जैसे LKO trains कभी-कभी AMG से diverting होती हैं) — इससे app आपकी journey सही तरीके से पहचान पाएगा।",
            profile_saved_synced: "Profile Save और Sync हो गई!",
            profile_locked_desc: "बदलाव करने के लिए पहले 'Edit Profile' पर tap करें।",
            dest_diversion_saved: "Destination और Diversion settings save और sync हो गईं।",
            ...
            tap_row_edit_delete: "👆 edit या delete करने के लिए नीचे किसी भी row पर tap करें",
            earnings_tap_hint: "EFT, Cases, Amount के boxes में type करें और फिर Save करें, ताकि आपकी Earnings track हो सके।",
            tap_colored_date_hint: "👆 duty details देखने के लिए किसी भी रंगीन तारीख पर tap करें",
            bordered_days_hint: "👆 किसी भी दिन पर tap करें — border वाले दिन एक ही trip के हिस्से हैं। किसी भी छोर पर tap करने से नीचे वह अपने आप भर जाएगा।",
            arrows_history_hint: "💡 पिछली history देखने के लिए नीचे दिए ❮ ❯ arrows का इस्तेमाल करें।",
            tap_summary_trend_hint: "👆 6-महीने का trend देखने के लिए Summary पर tap करें →",
            ...
            backup_syncing_google: "आपका data Google में actively sync हो रहा है।",
            install_home_screen_desc: "तेज़ और full-screen experience के लिए इस app को अपनी home screen पर add करें — अब इसे browser link से खोलने की ज़रूरत नहीं।",
            ...
            chain_prev_ended_hq: "पिछली journey HQ पर खत्म हुई थी। नई journey HQ से ही शुरू होनी चाहिए।",
            ...
            chain_station_mismatch: "पिछली journey {stn1} पर खत्म हुई थी, लेकिन यह नई journey {stn2} से शुरू हो रही है।\n\nक्या यह train diversion की वजह से है (जैसे वापसी वाली train original destination की जगह किसी नज़दीकी station पर रुकी)?\n\nअगर यह सच में एक गलती है, तो Cancel पर tap करके station ठीक करें।",
            chain_first_journey_hq: "आपकी सबसे पहली duty journey HQ से ही शुरू होनी चाहिए।",
            ...
            add_arrival_date_mandatory: "Arrival Date भरना ज़रूरी है।\n\nआज या आने वाली journeys के लिए Arrival Time खाली छोड़ा जा सकता है (pending दिखेगा)।",
            add_arrival_time_mandatory: "पिछली journeys के लिए Arrival Time भरना ज़रूरी है।\n\nसिर्फ आज या आने वाली duty entries में arrival time बाद में भरा जा सकता है।",
            add_same_station: "From और To station एक जैसे नहीं हो सकते।",
            add_arrival_after_departure: "Arrival, Departure के बाद ही होनी चाहिए।",
            ...
            leave_station_mandatory: "{type} के लिए Station Name भरना ज़रूरी है।",
            leave_objective_mandatory: "HQ के बाहर {type} के लिए Objective of Duty भरना ज़रूरी है (यह TA Journal पर print होगा)।",
            ...
            pdf_unpaired_diversion_block: "[{info}] जोड़ते समय एक gap मिला, और यह आपकी Profile में saved diversion pair नहीं है।\n\nजब तक यह ठीक नहीं होता, PDF generation block रहेगा:\n\n• अगर यह सच में एक diversion है, तो पहले इसे Profile → Destination & Diversion Stations में diversion pair के रूप में add करें, फिर दोबारा try करें।\n\n• नहीं तो पहले All Journey में missing connecting journey जोड़ें।",
            pdf_nda_16th_notice: "पूरा NDA generate करने के लिए, पक्का करें कि आपने पिछले महीने की 16 तारीख से Duty Journey भर दी है।",
            pdf_workingdays_earnings_empty: "Working Days और Earnings खाली हैं। फिर भी PDF generate करें?",
            pdf_earnings_not_filled: "इस महीने के लिए आपने Earnings entries नहीं भरी हैं (Earnings tab, All Journey के अंदर)। यहां Amount ₹0 दिखा रहा है। पहले भरें, या अगर सच में इस महीने कुछ नहीं है तो वैसे भी generate करें।",
            pdf_recheck_values: "Working Days: {wDays} · Earnings: ₹{earn}\n\nये आपकी logged entries से auto-fetch हुए हैं — print करने से पहले दोनों एक बार ज़रूर check कर लें।",

            dest_diversion_stations_desc: "उन trains के लिए जो कभी-कभी अपने major destination station से किसी नज़दीकी station पर diversion लेती हैं (जैसे LKO trains AMG से diverting होती हैं)। यह optional है — सिर्फ तभी add करें जब आपको अपने usual routes पर किसी specific diversion के बारे में पता हो।",
            quickadd_desc_hint: "📍 अपना team number एक बार <b>Roster</b> के अंदर select करें, फिर आप अपनी आने वाली duties यहां Quick Add पर एक tap से add कर सकते हैं।",
            delete_entry_warning: "Entry delete करने से आपकी continuous journey chain टूट सकती है। बाद में missing legs जोड़कर इसे ठीक किया जा सकता है।\n\nक्या आप वाकई delete करना चाहते हैं?",
            journey_time_overlap: "इस journey का arrival time आपकी अगली journey के departure time ({date} {time}) से overlap कर रहा है।\n\nएक समय पर सिर्फ एक ही train journey possible है — कृपया times check करें।"
        }
    };
