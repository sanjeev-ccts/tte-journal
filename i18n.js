...
(function () {
    ...
    const DICT = {
        ...
        hi: {
            ...
            close_anim_row: "डायलॉग बंद होने का एनिमेशन",
            ...
            pdf_browser_recommend: "TA और NDA PDF फाइलें प्रिंट करना Google Chrome और इसी तरह के chromium ब्राउज़र पर सबसे बेहतर काम करता है।",
            quick_add: "क्विक ऐड",
            ...
            sheet_add_confirm_msg: "यह journey entry जोड़ें?",
            sheet_save_confirm_msg: "यह journey entry सेव करें?",
            sheet_save_edited_confirm_msg: "इन entries में किए गए बदलाव सेव करें?",
            ...
            mandali_train_hint: "किसी भी ट्रेन नंबर पर tap करें और देखें कौन सी टीम उसे चला रही है",
            ...
            sleep_real_info_text: "यह आपकी अब तक फीड की गई असली journeys पर आधारित है — किसी fixed schedule पर नहीं। जैसे-जैसे महीने में आपकी journey feeding आगे बढ़ेगी, यह और सटीक होता जाएगा।",
            sleep_start_label: "नींद शुरू",
            sleep_end_label: "नींद खत्म",
            sleep_month_label: "महीना",
            sleep_range_hint: "चुनने योग्य नींद रेंज: 22:00 – 08:00",
            ...
            sleep_real_summary_future: "कुल: {month} में {trains} में {hrs} घंटे की नींद खराब होगी (अब तक feed की गई journeys के आधार पर)",
            sleep_real_empty_past: "🎉 अब तक feed की गई journeys के आधार पर {month} में कोई नींद खराब नहीं हुई!",
            sleep_real_empty_current: "🎉 अब तक feed की गई journeys के आधार पर {month} में कोई नींद खराब नहीं हो रही!",
            hrs_ruined_suffix: "घंटे खराब हुए",
            sleep_real_total_label: "कुल नींद के घंटे खराब (वास्तविक)",
            sleep_ideal_connecting: "Roster से जुड़ रहे हैं (पहली बार थोड़ा समय लग सकता है)…",
            sleep_ideal_fetching: "आदर्श आंकड़ा लाया जा रहा है…",
            sleep_ideal_failed: "Roster तक नहीं पहुंच सके — फिर से कोशिश करें।",
            sleep_ideal_no_team: "आदर्श आंकड़ा देखने के लिए पहले Roster में अपनी टीम चुनें।",
            sleep_ideal_label: "आदर्श (शेड्यूल आधारित)",
            ...
            quickadd_desc_hint: "📍 अपनी आने वाली duties यहां Quick Add पर एक क्लिक से add कर सकते हैं।",
